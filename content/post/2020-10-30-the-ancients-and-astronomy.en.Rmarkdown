...
From the above expression it is clear that if two objects are at the same distance (L), their diameters should have the same ratio as their angular distance.
...
The circumference of the earth had been established as approximately 39,700 kms by Eratosthenes, the radius can be easily calculated from this : 6,318 kms

The radius of the moon is then given by 
$$ \frac{R_e}{3.7} = \frac{6318}{3.7} = 1,707 kms $$
This is remarkably close to the modern estimate of 1,736 kms
...
![](/post/2020-10-30-the-ancients-and-astronomy.en_files/parallax.png)
...
This is close to the modern estimate of 384,400 kms.
...
![](/post/2020-10-30-the-ancients-and-astronomy.en_files/Distance_to_the_sun.PNG)
